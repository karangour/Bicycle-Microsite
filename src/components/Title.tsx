          ...
          <div className="max-w-[580px] flex flex-col">
            <div className="space-y-2">
              <h1 className="text-white text-[3.25rem] leading-tight font-title font-semibold">
                Bicycle for Online Travel Agencies (OTAs)
              </h1>
              <p className="text-white text-[1.25rem] font-body font-normal">
                Transform your OTA data into actionable insights with Bicycle's
                24/7 Analyst Copilot designed specifically for the travel
                industry.
              </p>
            </div>
            <div className="mt-10">
